...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$FileStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
class _$LoadingImpl<T> with DiagnosticableTreeMixin implements _Loading<T> {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties.add(DiagnosticsProperty('type', 'FileState<$T>.loading'));
  }
...
abstract class _Loading<T> implements FileState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$FileStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$FileStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
class _$ErrorImpl<T> with DiagnosticableTreeMixin implements _Error<T> {
  ...
  @override
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'FileState<$T>.error(networkExceptions: $networkExceptions)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(DiagnosticsProperty('type', 'FileState<$T>.error'))
...
abstract class _Error<T> implements FileState<T> {
